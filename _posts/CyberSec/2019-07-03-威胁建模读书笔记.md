...
### 问题2： 哪些地方可能出错？
核心问题2（哪里可能出错）。要回答这个问题，引用“0x04 攻击库” 细节 VS 抽象章节<br>
在一个DFD图中，我们可以通过STRIDE --> OWASP TOP10 --> CAPEC --> Checklist --> Test Case<br>
来识别可能出错的地方，威胁也好，漏洞也好，关键是找到可能出错的地方<br>
这些方法比如STRIDE、OWASP TOP10、CAPEC抽象等级是不一样的，选取什么方法取决于受众，当然你可以同时使用所有方法<br>
...
[2] [Microsoft SDL](https://www.microsoft.com/en-us/securityengineering/sdl/practices)
