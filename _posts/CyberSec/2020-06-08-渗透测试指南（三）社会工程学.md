...
图片来自[](https://blog.malwarebytes.com/cybercrime/social-engineering-cybercrime/2017/03/sms-phishing-for-the-masses/)
...
## 害怕(fear)
攻击者可以通过恐吓让被攻击者感到害怕，并失去理智快速做出错误的决策。比如发送一封邮件给你内容是xxx，经过一段时间的收集，我们手上掌握了你访问 ****hub 的视频，如果不想我把视频发给你的朋友，就快转1个比特币给账户xxxxxxxx。

这时候你很害怕，心里想着 不就是访问github吗？你倒是发啊！！但是心细的你看到四个*,说明肯定不是github，于是就老老实实的转了1个比特币。
